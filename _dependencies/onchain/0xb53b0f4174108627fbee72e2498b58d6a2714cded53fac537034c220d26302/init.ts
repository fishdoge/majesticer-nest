...
import * as governanceWitness from "./governance-witness/structs";
...
export function registerClasses(loader: StructClassLoader) { loader.register(versionControl.V__DUMMY);
loader.register(versionControl.V__0_1_1);
loader.register(governanceWitness.GovernanceWitness);
