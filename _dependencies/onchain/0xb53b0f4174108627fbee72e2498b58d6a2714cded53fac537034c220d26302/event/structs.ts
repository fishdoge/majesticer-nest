...
export function isPythInitializationEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::event::PythInitializationEvent`; }
...
export class PythInitializationEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::event::PythInitializationEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = PythInitializationEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::event::PythInitializationEvent`; readonly $typeArgs: []; readonly $isPhantom = PythInitializationEvent.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: PythInitializationEventFields, ) { this.$fullTypeName = composeSuiType( PythInitializationEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::event::PythInitializationEvent`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): PythInitializationEventReified { return { typeName: PythInitializationEvent.$typeName, fullTypeName: composeSuiType( PythInitializationEvent.$typeName, ...[] ) as `${typeof PKG_V1}::event::PythInitializationEvent`, typeArgs: [ ] as [], isPhantom: PythInitializationEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PythInitializationEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PythInitializationEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => PythInitializationEvent.fromBcs( data, ), bcs: PythInitializationEvent.bcs, fromJSONField: (field: any) => PythInitializationEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => PythInitializationEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => PythInitializationEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => PythInitializationEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => PythInitializationEvent.fetch( client, id, ), new: ( fields: PythInitializationEventFields, ) => { return new PythInitializationEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): PythInitializationEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isPythInitializationEvent(data.bcs.type)) { throw new Error(`object at is not a PythInitializationEvent object`); }

 return PythInitializationEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return PythInitializationEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isPriceFeedUpdateEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::event::PriceFeedUpdateEvent`; }
...
export class PriceFeedUpdateEvent implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::event::PriceFeedUpdateEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = PriceFeedUpdateEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::event::PriceFeedUpdateEvent`; readonly $typeArgs: []; readonly $isPhantom = PriceFeedUpdateEvent.$isPhantom;

 readonly priceFeed: ToField<PriceFeed>; readonly timestamp: ToField<"u64">

 private constructor(typeArgs: [], fields: PriceFeedUpdateEventFields, ) { this.$fullTypeName = composeSuiType( PriceFeedUpdateEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::event::PriceFeedUpdateEvent`; this.$typeArgs = typeArgs;

 this.priceFeed = fields.priceFeed;; this.timestamp = fields.timestamp; }

 static reified( ): PriceFeedUpdateEventReified { return { typeName: PriceFeedUpdateEvent.$typeName, fullTypeName: composeSuiType( PriceFeedUpdateEvent.$typeName, ...[] ) as `${typeof PKG_V1}::event::PriceFeedUpdateEvent`, typeArgs: [ ] as [], isPhantom: PriceFeedUpdateEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PriceFeedUpdateEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PriceFeedUpdateEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => PriceFeedUpdateEvent.fromBcs( data, ), bcs: PriceFeedUpdateEvent.bcs, fromJSONField: (field: any) => PriceFeedUpdateEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => PriceFeedUpdateEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => PriceFeedUpdateEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => PriceFeedUpdateEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => PriceFeedUpdateEvent.fetch( client, id, ), new: ( fields: PriceFeedUpdateEventFields, ) => { return new PriceFeedUpdateEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): PriceFeedUpdateEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isPriceFeedUpdateEvent(data.bcs.type)) { throw new Error(`object at is not a PriceFeedUpdateEvent object`); }

 return PriceFeedUpdateEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return PriceFeedUpdateEvent.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
