...
export function isEmitterCreated(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::emitter::EmitterCreated`; }
...
export class EmitterCreated implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::emitter::EmitterCreated`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = EmitterCreated.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::emitter::EmitterCreated`; readonly $typeArgs: []; readonly $isPhantom = EmitterCreated.$isPhantom;

 readonly emitterCap: ToField<ID>

 private constructor(typeArgs: [], fields: EmitterCreatedFields, ) { this.$fullTypeName = composeSuiType( EmitterCreated.$typeName, ...typeArgs ) as `${typeof PKG_V1}::emitter::EmitterCreated`; this.$typeArgs = typeArgs;

 this.emitterCap = fields.emitterCap; }

 static reified( ): EmitterCreatedReified { return { typeName: EmitterCreated.$typeName, fullTypeName: composeSuiType( EmitterCreated.$typeName, ...[] ) as `${typeof PKG_V1}::emitter::EmitterCreated`, typeArgs: [ ] as [], isPhantom: EmitterCreated.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => EmitterCreated.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => EmitterCreated.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => EmitterCreated.fromBcs( data, ), bcs: EmitterCreated.bcs, fromJSONField: (field: any) => EmitterCreated.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => EmitterCreated.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => EmitterCreated.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => EmitterCreated.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => EmitterCreated.fetch( client, id, ), new: ( fields: EmitterCreatedFields, ) => { return new EmitterCreated( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): EmitterCreated { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isEmitterCreated(data.bcs.type)) { throw new Error(`object at is not a EmitterCreated object`); }

 return EmitterCreated.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return EmitterCreated.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isEmitterDestroyed(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::emitter::EmitterDestroyed`; }
...
export class EmitterDestroyed implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::emitter::EmitterDestroyed`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = EmitterDestroyed.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::emitter::EmitterDestroyed`; readonly $typeArgs: []; readonly $isPhantom = EmitterDestroyed.$isPhantom;

 readonly emitterCap: ToField<ID>

 private constructor(typeArgs: [], fields: EmitterDestroyedFields, ) { this.$fullTypeName = composeSuiType( EmitterDestroyed.$typeName, ...typeArgs ) as `${typeof PKG_V1}::emitter::EmitterDestroyed`; this.$typeArgs = typeArgs;

 this.emitterCap = fields.emitterCap; }

 static reified( ): EmitterDestroyedReified { return { typeName: EmitterDestroyed.$typeName, fullTypeName: composeSuiType( EmitterDestroyed.$typeName, ...[] ) as `${typeof PKG_V1}::emitter::EmitterDestroyed`, typeArgs: [ ] as [], isPhantom: EmitterDestroyed.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => EmitterDestroyed.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => EmitterDestroyed.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => EmitterDestroyed.fromBcs( data, ), bcs: EmitterDestroyed.bcs, fromJSONField: (field: any) => EmitterDestroyed.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => EmitterDestroyed.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => EmitterDestroyed.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => EmitterDestroyed.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => EmitterDestroyed.fetch( client, id, ), new: ( fields: EmitterDestroyedFields, ) => { return new EmitterDestroyed( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): EmitterDestroyed { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isEmitterDestroyed(data.bcs.type)) { throw new Error(`object at is not a EmitterDestroyed object`); }

 return EmitterDestroyed.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return EmitterDestroyed.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isEmitterCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::emitter::EmitterCap`; }
...
export class EmitterCap implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::emitter::EmitterCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = EmitterCap.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::emitter::EmitterCap`; readonly $typeArgs: []; readonly $isPhantom = EmitterCap.$isPhantom;

 readonly id: ToField<UID>; readonly sequence: ToField<"u64">

 private constructor(typeArgs: [], fields: EmitterCapFields, ) { this.$fullTypeName = composeSuiType( EmitterCap.$typeName, ...typeArgs ) as `${typeof PKG_V1}::emitter::EmitterCap`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.sequence = fields.sequence; }

 static reified( ): EmitterCapReified { return { typeName: EmitterCap.$typeName, fullTypeName: composeSuiType( EmitterCap.$typeName, ...[] ) as `${typeof PKG_V1}::emitter::EmitterCap`, typeArgs: [ ] as [], isPhantom: EmitterCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => EmitterCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => EmitterCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => EmitterCap.fromBcs( data, ), bcs: EmitterCap.bcs, fromJSONField: (field: any) => EmitterCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => EmitterCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => EmitterCap.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => EmitterCap.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => EmitterCap.fetch( client, id, ), new: ( fields: EmitterCapFields, ) => { return new EmitterCap( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): EmitterCap { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isEmitterCap(data.bcs.type)) { throw new Error(`object at is not a EmitterCap object`); }

 return EmitterCap.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return EmitterCap.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
