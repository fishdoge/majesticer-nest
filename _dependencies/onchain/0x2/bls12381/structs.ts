...
export function isScalar(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V30}::bls12381::Scalar`; }
...
export function isG1(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V30}::bls12381::G1`; }
...
export function isG2(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V30}::bls12381::G2`; }
...
export function isGT(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V30}::bls12381::GT`; }
...
export function isUncompressedG1(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V30}::bls12381::UncompressedG1`; }
